...
$options_reflet = array(
				elgg_echo('degust:reflet:violace_jeune')=>'violace_jeune',
                                elgg_echo('degust:reflet:violine') => 'violine',
				elgg_echo('degust:reflet:grenat') => 'grenat',
                                elgg_echo('degust:reflet:carmin') => 'carmin',
                                elgg_echo('degust:reflet:brique') => 'brique',
