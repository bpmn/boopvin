...
?>
.elgg-icon-hj {
background:transparent url(<?php echo $graphics_url ?>buttons/controls.png) no-repeat;
}
.elgg-icon-hj:hover {
background:transparent url(<?php echo $graphics_url ?>buttons/controls_hover.png) no-repeat;
}
